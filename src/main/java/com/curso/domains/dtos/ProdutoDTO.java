...
public class ProdutoDTO {
    ...
    public @NotNull(message = "O campo codigoBarra não pode ser nulo") @NotBlank(message = "O campo codigoBarra não pode estar vazio") String getCodigoBarra(){
        return codigoBarra;
    }

    public void setCodigoBarra (@NotNull(message = "O campo codigoBarra não pode ser nulo") @NotBlank(message = "O campo codigoBarra não pode estar vazio") String codigoBarra){
